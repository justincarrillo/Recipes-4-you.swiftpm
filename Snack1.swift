        ...
        ScrollView{
            VStack{
                ...
                Text("16. Roll into a ball, making sure the shape is taller  rather than wide almost like a cylinder. this helps the cookies bake up thicker.")
                    .font(.caption)
                    .foregroundColor(.white)
                Text("17. Repeat with remaining dough place 8-9 balls of dough onto each cookie sheet")
                    .font(.caption)
                    .foregroundColor(.white)
                Text("18. bake the cokkies for 12-13 minutes or until the edges are very lightly browned. the centers will look very soft, but the cookies will continue to set as they cool.")
                    .font(.caption)
                    .foregroundColor(.white)
                Text("19. cool on the baking sheet for 10 minutes. meanwhile. press a few extra chocolate chips intp the tops of the warm cookies. This is optional and only for looks after")
                    .font(.caption)
                    .foregroundColor(.white)
