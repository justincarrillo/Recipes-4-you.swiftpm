        ...
        ScrollView{
            VStack{
                ...
                Text("4. Bring a boil then lower the heat")
                    ...
                    .foregroundColor(.white)
                    .multilineTextAlignment(.center)
                Text("5. Cover and let simmer for about 20 minutes until the liquid has reduced")
                    .font(.caption)
                    .foregroundColor(.white)
                    .multilineTextAlignment(.center)
                ...
                Text("8. Top each one with a spoonful of taco meat")
                    ...
                    .foregroundColor(.white)
                    .multilineTextAlignment(.center)
                Text("9. Fold the tortillas over and cook on both sides until golden brown and crispy")
                    .font(.caption)
                    .foregroundColor(.white)
                    .multilineTextAlignment(.center)
