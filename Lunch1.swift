...
struct Lunch1: View {
    var body: some View {
        ...
        Text("Heat oven to 425 f. Line cookie sheet with foil; spary with cooking spary, In shallow dish, place flour. In another dish, beat  egg and water. in third shallow dish, mix bread crumbs and cheese. Coat chicken with flour; dip into egg mixture, then coat with bread crumbs mixture. Plcae on cookie sheet. Bake 15 to 20 minutes, turning once, untill chicken is no longer pink in center and coating is golden brpwn. Serve with dipping sauce.")
